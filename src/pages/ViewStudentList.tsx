...
const ViewStudentList = () => {
  ...
  //           classObj._id
  //         }`;
  //         // const studentAttendanceLink = `${studentAttendanceBaseLink}/${student.id}`;
  ...
  //     // Combine all cards HTML into a single string
  //     const finalHTML = `
  //     <!DOCTYPE html>
  //         <html lang="en">
  //         <head>
  ...
  //     generatePDF(finalHTML, "All_Students_ID_Cards");
  ...
  //     <p className="text-xl">Download All Cards</p>
